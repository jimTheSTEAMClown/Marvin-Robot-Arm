...
#define code_name "marvin_pot_2_servo_test.ino"
...
#define code_version "0.0.1" // first push - 2025-07-11 by STEAM Clown 
#define code_last_modified "2025-07-11 - by STEAM Clown "
// Additional Comments:
// ------------------------------------------
...
int val_push_button_save_pos_pot; 
int val_analog_base_twist_pot;
int val_analog_base_shoulder_pot;
int val_analog_arm_elbow_pot;
int val_analog_arm_wrist_pot;
int val_analog_arm_gripper_pot; // TODO: maybe later...

// map POT values from Analog pins
int val_map_2_servo_base_twist_pot;
int val_map_2_servo_base_shoulder_pot;
int val_map_2_servo_arm_elbow_pot;
int val_map_2_servo_arm_wrist_pot;
int val_map_2_servo_arm_gripper_pot; // TODO: maybe later...
...
void read_pot(){
  // read PB and potentiometers
  val_analog_base_twist_pot    = analogRead(A0);
  val_analog_base_shoulder_pot = analogRead(A1);
  val_analog_arm_elbow_pot     = analogRead(A2);
  val_analog_arm_wrist_pot     = analogRead(A3);
  //val_analog_arm_gripper_pot  = analogRead(A4); // TODO: maybe later...

  // map from pot to servo milliseconds
  val_map_2_servo_base_twist_pot = map(val_analog_base_twist_pot, 0, 1023, 1000, 2000);
  val_map_2_servo_base_shoulder_pot = map(val_analog_base_shoulder_pot, 0, 1023, 1000, 2000);
  val_map_2_servo_arm_elbow_pot = map(val_analog_arm_elbow_pot, 0, 1023, 1000, 2000);
  val_map_2_servo_arm_wrist_pot = map(val_analog_arm_wrist_pot, 0, 1023, 1000, 2000);
  // val_map_2_servo_arm_gripper_pot = map(val_analog_arm_gripper_pot, 0, 1023, 1000, 2000);      ; // TODO: maybe later...
  if (debug >= 1) {
    Serial.println("Pot and Map Values: ";
    Serial.print(val_analog_base_twist_pot;
    Serial.println("Maps to ";
    Serial.print(val_map_2_servo_base_twist_pot;
    }
}
void move_all_servos_2_pos() {
